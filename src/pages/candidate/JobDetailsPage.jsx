...
const JobDetailsPage = ({ deletejob }) => {
    ...
    const handleEditButton = (id) => {
        navigate(`/company-portal/edit-jobs/${job.id}`)
    }
                        ...
                        <aside>
                            ...
                            {userType == 'company' ?
                                <div class="bg-white p-6 rounded-lg shadow-md mt-6">
                                    ...
                                    <button onClick={() => handleEditButton(job.id)} class="bg-indigo-500 hover:bg-indigo-600 text-white text-center font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline mt-4 block">Edit Job</button>
                                    <button
...
export { JobDetailsPage as default, singleJobLoader }